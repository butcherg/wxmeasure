...
#define MyAppName "wxmeasure"
#define MyAppVersion "0.1"
#define MyAppPublisher "Glenn Butcher"
#define MyAppExeName "wxmeasure.exe"
...
OutputDir=.
VersionInfoDescription=A simple photo measurement program.
VersionInfoCopyright=Copyright (C) 2025 Glenn Butcher.
